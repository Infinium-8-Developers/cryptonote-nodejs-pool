...
if (config.daemonType === "default" && config.cnAlgorithm === "ethash" && config.cnVariant === 2) 
{
	cnUtil= require('cryptoforknote-util-progpowz');
} else {
	cnUtil= require('cryptoforknote-util');
}
